...
package org.bitpipeline.app.iparkamsterdam.widget;

import org.bitpipeline.app.iparkamsterdam.R;
...
public class NumberPicker extends LinearLayout {
	...
	public NumberPicker (Context context, AttributeSet attrs) {
		...
		OnLongClickListener longClickListener = new OnLongClickListener () {
			 ...
			 * {@link NumberPickerButton} to inform us when the long click has
			 * ended.
			 */
	...
	private int getSelectedPos (String str) {
		if (mDisplayedValues == null) {
			...
			/*
			 * The user might have typed in a number into the month field i.e. 10
			 * instead of OCT so support that too.
			 */
			try {
				return Integer.parseInt (str);
			} catch (NumberFormatException e) {
